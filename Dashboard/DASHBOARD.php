    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/
hkrestaurant" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com/in/hetvi-kavathiya-ba823a2a8/" target="_blank">LinkedIn</a></li>
                    <li class="list-group-item"><a href="https://www.blog.com" target="_blank">Blog</a></li>
                    <li class="list-group-item"><a href="https://github.com/hetvikavathiya21" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                <div id="header">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="sun_f.jpg" alt="Logo" width="50"  class="float-right">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/hetvikavathiya21/web__programming/tree/main/Task%201">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/hetvikavathiya21/web__programming/tree/main/Task%202">Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="https://github.com/hetvikavathiya21/web__programming/tree/main/Task%203">Task 3</a></button>
